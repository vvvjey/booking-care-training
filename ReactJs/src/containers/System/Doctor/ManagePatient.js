...
class ManagePatient extends Component {
    ...
    getDataPatient = async ()=>{
        ...
        let users = await getListPatientForDoctor({doctorId:user.id,date:formatedDate})
        if(users && users.data.errCode===0){
            this.setState({
                dataPatient:users.data.data
            })
        }
