                    ...
                    <div className='home-header-content'>
                        ...
                        <div className='center-content'>
                            ...
                            <div className='child-conbtent'>
                                ...
                                <div className='subs-title'><FormattedMessage id="home-header.heath-facility" /></div>
                            </div>
                            <div className='child-conbtent'>
                            ...
                            <div className='child-conbtent'>
                                ...
                                <div className='subs-title'><FormattedMessage id="home-header.check-heath" /></div>
                            </div>
                    ...
                    <div className='home-header-banner'>
                        <div className='content-up'>
                            ...
                            <div className='search'>
                                ...
                                <input
                                    type='text'
                                    placeholder='find major to consult'
                                />
                            </div>
                        </div>
